...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEXT = """
`𝙷𝚎𝚕𝚕𝚘` [👿](https://thumbs.dreamstime.com/b/adolf-hitler-portrait-painted-b-jackobs-image-book-bilder-aus-dem-leben-des-führers-adolf-hitler-portrait-painted-183308284.jpg) `𝙼𝚢 𝚗𝚊𝚖𝚎 𝚒𝚜` *Hitler*
`𝙸'𝚖 𝚑𝚎𝚛𝚎 𝚝𝚘 𝚑𝚎𝚕𝚙 𝚢𝚘𝚞 𝚖𝚊𝚗𝚊𝚐𝚎 𝚢𝚘𝚞𝚛 𝚐𝚛𝚘𝚞𝚙𝚜! 𝙷𝚒𝚝` *📚𝙲𝚘𝚖𝚖𝚊𝚗𝚍𝚜*   
"""
buttons = [
    [
        InlineKeyboardButton(
            text="𝐀𝐝𝐝 𝐌𝐞 𝐓𝐨 𝐘𝐨𝐮𝐫 𝐏𝐥𝐚𝐜𝐞😇", url="t.me/groupmangeadolfhitlerbot?startgroup=true"),
    ],
     [
    [
...
evil_IMG = "https://thumbs.dreamstime.com/b/adolf-hitler-portrait-painted-b-jackobs-image-book-bilder-aus-dem-leben-des-führers-adolf-hitler-portrait-painted-183308284.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
